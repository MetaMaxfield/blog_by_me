...
- [Особенности](#особенности-разработки)
- [Структура проекта](#структура-проекта-директории-и-файлы)
- [Установка](#установка)
- [Источники](#источники)
...
- Плоская страница "О проекте" с формой для обратной связи с авторами;
...
- Реализованы структурные и функциональные тесты с использованием unittest и фабрик моделей для генерации тестовых данных;
...
└── setup_dev.py                            # Файл-скрипт для старта локальной разработки
```
